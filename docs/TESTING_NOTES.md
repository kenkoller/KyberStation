...
- [ ] Add more filterable tags for gallery browsing
- [ ] Preset thumbnails: show fully extended blade as default thumbnail
...
- [ ] Gallery description/info panel: move from bottom of gallery tab to top, sidebar, or other prominent location — currently buried below presets
...
- [ ] Tooltips need significant improvement — "leave a lot to be desired"
...
- [ ] Overall: pixel strip + RGB graph should feel like a distinct "dev workbench" zone below the saber preview
...
- [ ] **Vertical blade layout**: With the sidebar layout, the blade and pixel strip + RGB graph should render vertically instead of horizontally to make better use of the tall/narrow canvas area. Major canvas refactor — coordinate system, hilt drawing, strip, and graph all need rotation.
...
## Styles
- [ ] Add noise pattern directionality control for blade styles and effects (especially noticeable on Lightning effect)
- [ ] Painted style: interface is too complex / unclear — needs UX simplification
...
- [ ] Ignition/retraction animations: add more granular control (speed, intensity, stutter count, glitch behavior) — could be its own settings category
