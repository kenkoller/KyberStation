...
> **Last audited: 2026-05-16** — re-prioritized after PR #325 (v0.22.0 Runtime Presets) merged + bench-validated on 89sabers V3.9-BT. Closed by recent merges since 2026-05-12 audit: Runtime Presets export Phase A + C with 16-bit RGB scaling fix (#325 — the smoking-gun saga, full case study in `docs/HARDWARE_FIDELITY_PRINCIPLE.md` audit history), saber profile migration fixtures (#327), Fett263 import round-trip fixtures (#328), codegen int bare-literal double-wrap fix (#329), Fett263 template registry argcount fix (#330), bench validation curated presets (#331, in flight). Audit doc spawned: [`docs/research/EMIT_PARSER_AUDIT.md`](research/EMIT_PARSER_AUDIT.md) — the cheap-to-verify reference for every emit↔parser boundary.
>
