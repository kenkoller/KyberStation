...
| **Vendor board profile selector (v0.17 priority)** | [`SESSION_2026-05-14_V39BT_BENCH.md`](archive/SESSION_2026-05-14_V39BT_BENCH.md) | L | 2026-05-14 hardware session proved KyberStation default-config does not boot on 89sabers V3.9-BT (chassis ships with `NUM_BLADES=2`, 128 LED main + 30 LED crystal chamber, custom pin assignments; KyberStation defaults assume stock single-blade Proffieboard). Add chassis picker (89sabers V3.9 / V3.9-BT / Kylo / KR / Saberbay / Vader's Vault / Sabertrio / stock Hubbe) that pins codegen to the vendor's known-good baseline. Without this, KyberStation defaults fail on the most common community hardware. |
...
| **End-user boot diagnostic workflow** | [`SESSION_2026-05-14_V39BT_BENCH.md`](archive/SESSION_2026-05-14_V39BT_BENCH.md) | S (doc) | Document boot-capture flow in [`FLASH_GUIDE.md`](FLASH_GUIDE.md): when a flash fails, attach `screen /dev/cu.usbmodem* 115200` (or `scripts/hardware-test/proffie-serial.sh`) to capture ProffieOS init logs. Users paste the log into a GitHub issue. Unblocks remote-diagnosed bug reports rather than guess-and-retry. |
| **Vendor compatibility matrix (public doc)** | [`SESSION_2026-05-14_V39BT_BENCH.md`](archive/SESSION_2026-05-14_V39BT_BENCH.md) | S | New `docs/HARDWARE_COMPATIBILITY.md` table of (vendor, chassis, ProffieOS version, KyberStation default works?, known config delta). First-mover rows: `89sabers V3.9-BT — ❌ (needs vendor profile or factory config import)`, `stock Proffieboard V3.9 from Hubbe — TBD (no test board yet)`. PR-able as more boards get tested by the community. |
