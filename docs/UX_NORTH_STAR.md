...
| Axis | Direction |
|------|-----------|
| **Typography** | Inter (humanist sans, chrome + labels) + JetBrains Mono (all data / numerics / code / identifiers / ceremonial display at 80–120px). Row rhythm 24–28px. Minimum 16–18px for live telemetry. No third typeface. |
...
4. **Ceremonial display-weight type.** Currently locked as JetBrains Mono Bold at 80–120px for reveal moments. If typographic practice reveals this reads too "code-font," a secondary display face (candidate: GT America Mono or a geometric display) may need to join the system.
