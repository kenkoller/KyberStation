...
**Hard rules:**
- Keep DMs under 500 chars (TikTok's ~1000 limit feels spammy if used)
- Comments should be genuine engagement, not promo-spam
- Never ask for a feature in the first DM
- If they reply with interest, *then* offer a video sample / Kyber Code
...
- For builders: emphasize "designing blade styles"
- For dueling content: emphasize "preset library, fast switching"
- For collectors / display: emphasize "gallery + character presets"
...
**Goal:** Give them a 5-10 second video clip they can drop into their
...
style] and send you the source video, so you can drop it in if you
ever want. No expectation that you'll use it; just easier than asking
...
direction in the clip, not yours. They're more likely to share content
