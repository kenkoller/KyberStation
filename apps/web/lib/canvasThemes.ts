...
export const CANVAS_THEMES: CanvasTheme[] = [
  // ─── Deep Space ─── Cool void, electric blue
  {
    ...
    ui: {
      ...
      // 2026-04-23 contrast fix: was 106 110 120 (3.76:1 on bg-secondary,
      // fails WCAG AA 4.5:1). Bumped +40 each channel to 146 150 160
      // (≈5.1:1) alongside the globals.css --text-muted bump in the
      // modulation v1.0 sprint.
      textMuted: '146 150 160',
  ...
  // ─── Tatooine ─── Sandy gold, amber accent
  {
    ...
    ui: {
      ...
      textMuted: '178 166 144',
      borderSubtle: 'rgba(255, 200, 120, 0.17)',
      borderLight: 'rgba(255, 200, 120, 0.26)',
      crystalColor: '#ffb84d',
    },
  },
  ...
  // ─── Bespin ─── Sunset coral, warm cloud city glow
  {
    ...
    ui: {
      ...
      textMuted: '178 166 158',
      borderSubtle: 'rgba(255, 160, 120, 0.17)',
      borderLight: 'rgba(255, 160, 120, 0.26)',
      crystalColor: '#ff8866',
    },
  },
  ...
  // ─── Dagobah ─── Swamp emerald, vivid green
  {
    ...
    ui: {
      ...
      textMuted: '144 178 148',
      borderSubtle: 'rgba(100, 200, 100, 0.17)',
      borderLight: 'rgba(100, 200, 100, 0.26)',
      crystalColor: '#4adf6a',
    },
  },
  ...
  // ─── Mustafar ─── Volcanic ember, fiery red-orange
  {
    ...
    ui: {
      ...
      textMuted: '178 150 142',
      borderSubtle: 'rgba(255, 100, 40, 0.17)',
      borderLight: 'rgba(255, 100, 40, 0.26)',
      crystalColor: '#ff5533',
    },
  },
  ...
  // ─── Hoth ─── Icy blue, frozen tundra
  {
    ...
    ui: {
      ...
      textMuted: '146 168 184',
      borderSubtle: 'rgba(140, 180, 255, 0.17)',
      borderLight: 'rgba(140, 180, 255, 0.26)',
      crystalColor: '#66bbff',
    },
  },
  ...
  // ─── Coruscant ─── Neon midnight, purple-blue cityscape
  {
    ...
    ui: {
      ...
      textMuted: '144 144 184',
      borderSubtle: 'rgba(80, 140, 255, 0.17)',
      borderLight: 'rgba(80, 140, 255, 0.26)',
      crystalColor: '#8080ff',
    },
  },
  ...
  // ─── Endor ─── Forest moonlit, natural green
  {
    ...
    ui: {
      ...
      textMuted: '146 162 128',
      borderSubtle: 'rgba(140, 180, 100, 0.17)',
      borderLight: 'rgba(140, 180, 100, 0.26)',
      crystalColor: '#88cc44',
    },
  },
  ...
  // ─── Death Star ─── Industrial steel, cold metallic gray
  {
    ...
    ui: {
      ...
      textMuted: '152 152 160',
      borderSubtle: 'rgba(180, 180, 200, 0.17)',
      borderLight: 'rgba(180, 180, 200, 0.26)',
      crystalColor: '#99aacc',
    },
  },
];
