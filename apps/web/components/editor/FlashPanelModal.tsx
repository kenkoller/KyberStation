...
/**
 * FlashPanelModal — thin wrapper around the existing <FlashPanel> body
 * rendered as a centered modal dialog.
 *
 * The persistent Delivery rail (OV4) surfaces FLASH at the bottom of
 * every tab. Clicking that segment opens this modal. The existing
 * `<FlashPanel>` component stays alive as a panel-renderable consumer
 * (the editor Output tab may still host it via layoutStore); this
 * modal is a second mount point triggered by the rail.
 *
 * Behavior mirrors CardWriterModal — centered portal, ESC + backdrop
 * close, focus trap, internal scroll when needed.
 */
  ...
  const dialog = (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="flashpanel-modal-heading"
