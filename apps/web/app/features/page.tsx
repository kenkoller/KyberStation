...
const SAMPLE_PROFFIE_OUTPUT = `// Generated by KyberStation · ProffieOS 7.x target
#include "styles/Layers.h"

// Luke Skywalker — A New Hope (stable blue, 144 px)
using LukeANH = StylePtr<
  InOutTrL<
    Layers<
      AudioFlicker<Rgb<0,135,255>, Mix<Int<16384>, Rgb<0,135,255>, White>>,
      BlastL<White, 200, 100, Bump<Int<16384>, Int<6000>>>,
      SimpleClashL<White, 40>,
      LockupTrL<
        AlphaL<White, Bump<Int<16384>, Int<12000>>>,
        TrInstant,
        TrFade<300>,
        SaberBase::LOCKUP_NORMAL
      >
    >,
    TrWipeSparkTip<White, 320>,
    TrWipeInSparkTip<White, 420>
  >
>();`;
        ...
        >
          ...
          <div className="mt-8">
            <ScrollReveal variant="fade-up" delay={120}>
              <InlineCodePeek
                filename="preset_luke_anh.cpp"
                code={SAMPLE_PROFFIE_OUTPUT}
                maxLines={22}
              />
            </ScrollReveal>
            <p className="mt-3 dot-matrix tabular-nums text-text-muted">
              SAMPLE OUTPUT · GENERATED FROM ONE PRESET · DROP STRAIGHT INTO ARDUINO IDE
            </p>
          </div>
        </MarketingSection>
      </ScrollReveal>
