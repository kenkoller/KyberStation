...
export const ANIMATED_SERIES_PRESETS: Preset[] = [
  ...
  // ── Huyang ──
  {
    ...
    screenAccurate: true,
    description:
      'The ancient droid lightsaber architect\'s personal blade. A clean, precise blue reflecting 25,000 years of saber construction expertise.',
    hiltNotes: 'Personal lightsaber of the ancient droid, rarely used in combat.',
    config: {
      name: 'Huyang',
