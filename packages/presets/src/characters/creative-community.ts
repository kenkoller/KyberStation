...
export const CREATIVE_COMMUNITY_PRESETS: Preset[] = [
  ...
  // ── Relocated from canonical files (Phase 3b, 2026-04-23) ──
  // These presets depicted non-canonical scenarios — moved from canonical
  // files to creative-community with screenAccurate: false and reframed
  // descriptions.

  {
    id: 'creative-palpatine-speculative',
    name: 'Emperor Palpatine (Speculative)',
    character: 'Palpatine',
    era: 'expanded-universe',
    affiliation: 'other',
    tier: 'detailed',
  ...
  {
    id: 'creative-obiwan-force-ghost',
  ...
  {
    id: 'creative-morgan-elsbeth-nightsister',
    name: 'Morgan Elsbeth (Nightsister — Speculative)',
